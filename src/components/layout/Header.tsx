      ...
      >
        ...
        <div className="flex-1 flex justify-end items-center gap-4">
          <div className="hidden lg:flex items-center gap-1.5 p-1 rounded-full border border-slate-200 bg-slate-50/50">
            ...
            <Link href="https://www.facebook.com/profile.php?id=61591918929725" target="_blank" rel="noopener noreferrer" className="p-1.5 text-slate-600 hover:text-teal-600 hover:bg-white rounded-full transition-all duration-300">
              <Facebook size={16} />
            </Link>
            <Link href="https://www.tiktok.com/@afaq_alquran_academy" target="_blank" rel="noopener noreferrer" className="p-1.5 text-slate-600 hover:text-teal-600 hover:bg-white rounded-full transition-all duration-300">
